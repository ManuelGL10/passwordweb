...
const PasswordTable = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://passguard-server.onrender.com/get_passwords", {
        headers: { userId },
      })
  ...
  const handleAddPassword = async () => {
    ...
    try {
      ...
      const response = await fetch('https://passguard-server.onrender.com/post_passwords', {
        method: 'POST',
        headers: {
      ...
      await fetch('https://passguard-server.onrender.com/sendNotification', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const savePasswordToIndexedDB = (password) =>{
    ...
    const deletePassword = (id) => {
      ...
      axios.delete(`https://passguard-server.onrender.com/delete/${id}`, {
